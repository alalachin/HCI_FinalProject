...
//				break;
	...
	void Update()
	{
		...
		if(KinectInitialized)
		{
			...
			if(Player1Calibrated)
			{
                //startTime = Time.time;
                showTime();
				(gameObject.transform.parent.gameObject).gameObject.transform.parent.gameObject.GetComponent<CarController> ().Move (0f,0.3f,0.0f,0.0f);
    ...
    void showTime()
    {
        ...
        GameObject.Find("timer").GetComponent<UnityEngine.UI.Text>().text = nowTime.ToString("F1");
    }
